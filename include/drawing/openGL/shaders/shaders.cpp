...
**------------------------------------------------------------------------------------------*/
std::string shaders::loadShaderSource( const std::string& shaderPath )
{
	std::ifstream file;
...
**------------------------------------------------------------------------------------------*/
bool shaders::createShader(const std::string& shaderPath, GLenum shaderType, GLuint &shaderID)
{
	bool result = true;
...
**------------------------------------------------------------------------------------------*/
void shaders::printProgramInfoLog(GLuint program)
{
    int infologLength = 0;
...
**------------------------------------------------------------------------------------------*/
bool shaders::setupShaders(const std::string& vertexShaderPath, const std::string& fragmentShaderPath, GLuint &shaderProgram)
{
