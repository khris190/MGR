...
class myWindow:
    ...
    def on_run_clicked(self, button):
        prog =  os.path.dirname(__file__) + f'/bin/GenerativeArt -t 16 -i "{self.selectedFilename}" -p {self.GetPopCountValue()} -s {self.GetShapeCountValue()} -m {self.GetMutationValue()} --hours 0.15'
        print(prog)
